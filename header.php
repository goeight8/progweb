		...
		<div class="w3layouts-top-strip">
			<div class="container">
				...
				<div class="agileits-contact-info text-right">
					<ul>
						<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span><a href="<?php echo base_url();?>asset/mailto:info@example.com">gointernational8@gmail.com</a></li>
			  ...
			  <div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav">
					...
					<li><a href="<?php echo base_url();?>laporan">Lapor</a></li>
					<li><a href="<?php echo base_url();?>laporan/tampil_laporan">Galeri</a></li>
				  </ul>
				</div><!-- /.navbar-collapse -->
			  </div><!-- /.container-fluid -->
			</nav>
